...
const data=[
    {btn:"Click to try!",id:15,catagory:"React & Spring Boot",title:"Dablu",discription:"A group expense management application to track shared expenses, manage individual contributions, integrate external wallet APIs, and automate final settlement processing.",image:"wallet",link:"https://deepaknetwork.github.io/dablu"},
    ...
    {btn:"Go to repository",id:9,catagory:"Spring Boot (RestAPI)",title:"StudyHub",discription:"A student-teacher management system for efficient tracking and communication.",link:"https://github.com/deepaknetwork/PupilPro-REST-API"},
    {btn:"Go to repository",id:10,catagory:"Spring Boot (RestAPI)",title:"DoneIt" ,discription:"A simple to-do application for task management and organization.",image:"todo",link:"https://github.com/deepaknetwork/Todo-REST-API"},
...
const cont=[
    {id:1,image:"git",link:"https://github.com/deepaknetwork"},
    {id:2,image:"linkedin",link:"https://www.linkedin.com/in/deepakbasuvaraj/"},
    {id:3,image:"gmail",link:"mailto:deepaksmail2004@gmail.com"},
    {id:4,image:"insta",link:"https://www.instagram.com/dpk.cmd/"},
    {id:5,image:"whatsapp",link:"https://wa.me/9585010400"}]
