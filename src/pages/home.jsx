...
export default function Home(){
    ...
    function resume(){
        window.open('https://drive.google.com/file/d/1l9XV_QmCmh-yxQP6si4r5HmrQa8TrZr6/view?usp=drive_link',"_blank")
    }
    function fix(){
       ...
       <section className="home" >
        <Row className="s1">
            <Col lg={5} xs={11} className="b1">
                ...
                <span className="dis">I am a passionate and dedicated web developer with strong skills in Spring Boot, Express, React, Azure, Docker. I specialize in building dynamic and scalable web applications, utilizing modern technologies to create efficient, containerized solutions and seamless user experiences</span>
